 ...
 * Name:        Shida Yang
 * Lab #:       23195
 * Description: This program creates a real-time echo effect
 */
...
//increment is 0.25sec
#define increment_s 0.25
